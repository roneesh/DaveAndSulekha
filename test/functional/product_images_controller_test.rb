...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { image_type: @product_image.image_type, product_id: @product_image.product_id, source: @product_image.source }
    end
  ...
  test "should update product_image" do
    put :update, id: @product_image, product_image: { image_type: @product_image.image_type, product_id: @product_image.product_id, source: @product_image.source }
    assert_redirected_to product_image_path(assigns(:product_image))
  end

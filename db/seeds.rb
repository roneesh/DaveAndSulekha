...
products = [
  {name: "The R.P. Sharma in Green", price: 21, description: rp_desc, etsy_link: "https://www.etsy.com/listing/152200914/the-rp-sharma-pocket-square-in-green" },
...
products.each do |product|
  ...
  4.times do |n|
    if n == 0
      ...
      ProductImage.create(product_id: p.id, image_type: "gallery", source: img_url)
      puts "Created product image for product #{p.id}"
    end
  end
end
